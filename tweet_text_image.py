...
media_id = api.media_upload(filename="CEO.jpg").media_id_string
print(media_id)

# Text to be Tweeted
text = "attempt#4 Hello World! its the leprechauns in your computer.  if you can see the hamburger head CEO the test has passed.  congrats, text and image are connected"
